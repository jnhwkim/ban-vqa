...
def parse_args():
    ...
    parser.add_argument('--use_both', type=bool, default=True, help='use both train/val datasets to train?')
    parser.add_argument('--use_vg', type=bool, default=True, help='use visual genome dataset to train?')
